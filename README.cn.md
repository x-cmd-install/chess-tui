...
合计: **16,972** 行代码（覆盖前 5 种语言、共 **128** 个文件）。
...
- **上游仓库**: <https://github.com/thomas-mauran/chess-tui>
- **官网**: <https://thomas-mauran.github.io/chess-tui/>
- **许可证**: MIT
...
- **Star**: 1,180 · **Fork**: 78 · **开放 issue**: 135 · **贡献者**: 37

## 累计统计

- **发布数**: 26 · **已合并 PR**: 151 · **开放 PR**: 16 · **已关闭 issue**: 118 · **开放 issue**: 17 · **提交数**: 287
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/chess-tui.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260920.yml` · 2026-09-20T05:10:14Z._
